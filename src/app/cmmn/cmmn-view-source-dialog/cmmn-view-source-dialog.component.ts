 ...
 */
@Component({
  selector: 'app-cmmn-view-source-dialog',
  templateUrl: './cmmn-view-source-dialog.component.html',
  styleUrls: ['./cmmn-view-source-dialog.component.css'],
})
export class CmmnViewSourceDialogComponent implements OnInit {
