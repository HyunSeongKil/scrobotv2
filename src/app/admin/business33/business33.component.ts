 ...
 */
@Component({
  selector: 'app-business33',
  templateUrl: './business33.component.html',
  styleUrls: ['./business33.component.css'],
})
export class Business33Component implements OnInit {
  ...
  constructor(route: ActivatedRoute, private router: Router, private service: BbsService, private cmmnCodeService: CmmnCodeService) {
    ScUtil.loadStyle('../assets/css/business33.css');
  ...
  onDetailClick(bbsId: number): void {
    this.router.navigate(['admin/business36', bbsId], {
      queryParams: {
